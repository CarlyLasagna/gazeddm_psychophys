// PSYCHOPHYS STAN MODEL 3b (Gender Models Only)
// with trial-level variability on drift rates
...
data {
  ...
  array[N_obs] int gender;  // gender id of stim for each trial [integer vector; length N_obs];1=female;2=male
